...
# for brightness home
alias bgu1='xrandr --output DVI-I-3 --brightness 0.1'
alias bgu2='xrandr --output DVI-I-3 --brightness 0.2'
alias bgu3='xrandr --output DVI-I-3 --brightness 0.3'
alias bgu4='xrandr --output DVI-I-3 --brightness 0.4'
alias bgu5='xrandr --output DVI-I-3 --brightness 0.5'
alias bgu6='xrandr --output DVI-I-3 --brightness 0.6'
alias bgu7='xrandr --output DVI-I-3 --brightness 0.7'
alias bgu8='xrandr --output DVI-I-3 --brightness 0.8'
alias bgu9='xrandr --output DVI-I-3 --brightness 0.9'
alias bgu0='xrandr --output DVI-I-3 --brightness 1.0'
